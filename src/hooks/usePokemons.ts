...
export const useSortedPokemons = (pokemons: Pokemon[], sort: string): Pokemon[] => {
...
export const useFilteredPokemons = (pokemons: Pokemon[], filter: string[]): Pokemon[] => {
...
export const usePokemons = (pokemons: Pokemon[], sort: string, search: string, filter: string[]): Pokemon[] => {
